...
This is a RESTful HL7® FHIR® API specification for the *Canary API*.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/canary-api/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/canary-api/blob/master/CODE_OF_CONDUCT.md).
...
Successful deployment of the API Proxy requires:
 ...
 2. A *Key-Value Map* named `canary-variables-encrypted`, containing any secrets you might need at proxy runtime
